...
import watermelon.footballapp.databinding.FragmentTeamDetailsBinding
...
class TeamDetailsFragment() : BaseFragment<FragmentTeamDetailsBinding>() {
    ...
    override val inflate: (LayoutInflater, ViewGroup?, attachToRoot: Boolean) -> FragmentTeamDetailsBinding
